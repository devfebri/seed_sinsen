...
class Master_target_salesman extends CI_Controller
{
    ...
    public function make_query()
    {
        ...
        ->select('ts.target_salesman_global_cost')
        ->select('ts.cost_target_salesman_global')
        ->select('ts.cost_target_salesman_channel')
        ->select('ts.cost_target_salesman_global_cost')
