...
class Master_target_salesman_selling_price extends CI_Controller
{
    ...
    public function index()
    {
        ...
        foreach ($this->db->get()->result_array() as $row) {
            $row['action'] = $this->load->view('additional/md/h3/action_index_h3_md_master_target_salesman_selling_price', [
                'id' => $row['id']
            ], true);
    ...
    public function make_query()
    {
        ...
        ->select('ts.end_date')
        ->select('ts.jenis_target_salesman_selling_price')
        ->select('ts.target_salesman_selling_price_global')
        ->select('ts.target_salesman_selling_price_channel')
    ...
    public function make_datatables()
    {
        ...
        if($this->input->post('filter_produk') != null) $this->db->where('ts.jenis_target_salesman_selling_price', $this->input->post('filter_produk'));
