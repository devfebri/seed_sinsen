...
class Dgi_api_key extends CI_Controller
{
  ...
  //   $post = $this->input->post();
  //   $data   = [
  //     'id_dealer'     => $post['id_dealer_group'],
  //     'dealer_group'     => $post['dealer_group'],
  //     'api_key'     => $post['api_key_group'],
  //     'api_key_group'     => $post['api_key_group'],
  //     'secret_key'     => $post['secret_key_group'],
  ...
  //   ];
  //   $this->db->trans_begin();
  //   // $this->db->update('ms_dgi_api_key_group', ['active' => 0], ['id_dealer' => $post['id_dealer']]);
  ...
  //     $rsp = [
  //       'status' => 'sukses',
  //       'link' => base_url('master/dgi_api_key/setting')
  //     ];
  //     $_SESSION['pesan']   = "Data has been saved successfully";
  //     $_SESSION['tipe']   = "success";
  //   }
  //   echo json_encode($rsp);
  //   return redirect('master/dgi_api_key/setting');
  // } 
  ...
  //         $data = [
  //             'id_dealer_group' => $dealer['id_dealer_group'],
  //             'dealer_group' => $post['dealer_group'],
  //             'api_key' => $post['api_key_group'],
  //             'api_key_group' => $post['api_key_group'],
  //             'secret_key' => $post['secret_key_group'],
