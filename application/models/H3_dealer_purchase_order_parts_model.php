...
class h3_dealer_purchase_order_parts_model extends Honda_Model {
	...
	public function insert($data){
		...
		$data['harga_setelah_diskon'] = 0;
		$data['tot_harga_part'] = $data['kuantitas'] * $data['harga_setelah_diskon'];
		// $data['harga_setelah_diskon'] = harga_setelah_diskon($data['tipe_diskon'],
		//  $data['diskon_value'], $data['harga_saat_dibeli'], ($campaign != null AND $campaign['jenis_diskon_campaign'] == 'Additional'), $data['tipe_diskon_campaign'], $data['diskon_value_campaign']);
		// $data['tot_harga_part'] = $data['kuantitas'] * $data['harga_setelah_diskon'];
