            ...
            <div style='width: 100%;'>
                ...
                <div style='width: 50%; float: left;'>
                    <table class='table table-bordered'>
                        ...
                        <?php
                        $array1 = array_slice($parts, 0, 15);
                        $index = 0;
                        $i = 1;
                        while ($i < 16) {
                            echo "
                                 <tr>
                                    <td width='10%' height='18px;' style='font-size: 9px; padding:0px' class='text-center'>$i</td>
                                    <td width='26%' height='18px;' style='font-size: 9px;'>" . substr($array1[$index]['id_part'], 0, 16) . "</td>
                                    <td width='26%' height='18px;' style='font-size: 9px;'>" . substr($array1[$index]['nama_part'], 0, 30) . "</td>
                                    <td width='26%' height='18px;' style='font-size: 9px;'>" . $array1[$index]['kuantitas'] . "</td>
                                </tr>
                            ";
                            $i++;
                            $index++;
                ...
                <div style='width: 50%; float: left;'>
                    <table class='table table-bordered'>
                        ...
                        <?php
                            $array2 = array_slice($parts, 15, 30);
                            // var_dump($array2);
                            // die;
                            $ii = 16;
                            $indexx=0;
                            while ($ii < 31) {
                                echo "
                                    <tr>
                                        <td width='10%' height='18px;' style='font-size: 9px; padding:0px' class='text-center'>$ii</td>
                                        <td width='26%' height='18px;' style='font-size: 9px;'>" . substr($array2[$indexx]['id_part'], 0, 16) . "</td>
                                        <td width='26%' height='18px;' style='font-size: 9px;'>" . substr($array2[$indexx]['nama_part'], 0, 30) . "</td>
                                        <td width='26%' height='18px;' style='font-size: 9px;'>" . $array2[$indexx]['kuantitas'] . "</td>
                                    </tr>
                                    ";
                                    $ii++;
                                    $indexx++;
                        ...
                        <!-- <tr>
                            <td width='10%' height='10px;' style='font-size: 9px; padding:0px' class='text-center'>1</td>
                            <td width='26%' height='10px;' style='font-size: 9px;'>null</td>
                            <td width='26%' height='10px;' style='font-size: 9px;'>null</td>
                            <td width='26%' height='10px;' style='font-size: 9px;'>null</td>
                        </tr> -->
                        <!-- <tr>
