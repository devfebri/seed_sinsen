            ...
            <div class="col-md-12">
              <form class="form-horizontal" enctype="multipart/form-data">
                <div class="box-body">
                  ...
                  <?php $list_parts = '';
                  foreach ($purchase_order_parts as $part) : $list_parts .= ", " . $part['nama_part'];
                  endforeach;
                  $list_parts = substr($list_parts, 2); ?>
  ...
  <div class="box">
    <div class="box-header with-border">
      <h3 class="box-title">
        ...
        <a href="dealer/<?= $isi ?>/history" class="btn bg-blue btn-flat margin"> History</a>
      </h3>
    </div><!-- /.box-header -->
    <div class="box-body">
  ...
  <div class="box">
    <div class="box-header with-border">
      <h3 class="box-title">
        ...
        <a href="dealer/<?= $isi ?>" class="btn bg-red btn-flat margin"> Kembali</a>
      </h3>
    </div><!-- /.box-header -->
    <div class="box-body">
      <link rel="stylesheet" href="assets/css-progress-wizard-master/css/progress-wizard.min.css">
