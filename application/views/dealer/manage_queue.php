                ...
                <div class="box-body" v-if="mode=='insert' || mode=='edit'">
                  ...
                  <div class="" v-if="lengkap=='1'">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="form-group">
                        <div class="form-input">
                          <label for="inputEmail3" class="col-sm-2 control-label">Kelurahan <i style="color: red">*</i></label>
                          <div class="col-sm-3">
                            <input type="text" class="form-control" readonly v-model="customer.kelurahan" :required="edit_cust==''">
                          </div>
                        </div>
                      ...
                      <div class="form-group">
                        <div class="form-input">
                          ...
                          <div class="col-sm-4">
                            <input type="text" class="form-control" :minlength="8" :maxlength="8" name="no_polisi" v-model="customer.no_polisi" :required="edit_cust==''" :readonly="mode=='detail'">
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
                        <div class="form-input">
                          ...
                          <div class="col-sm-3">
                            <input type="text" class="form-control" name="id_tipe_kendaraan" readonly v-model="customer.tipe_ahm" :required="edit_cust==''">
                          </div>
                        </div>
                        <div class="col-sm-1">
                      ...
                      <div class="form-group">
                        <div class="form-input">
                          <label for="inputEmail3" class="col-sm-2 control-label">No. Mesin <i style="color: red">*</i></label>
                          <div class="col-sm-4">
                            <input type="text" :minlength="12" id="no_mesin_input" :maxlength="12" class="form-control" required name="no_mesin" id="no_mesin" :readonly="edit_cust==''" v-model="customer.no_mesin">
                          </div>
                        </div>
                        <div class="form-input">
                          <label for="inputEmail3" class="col-sm-2 control-label">No. Rangka <i style="color: red">*</i></label>
                          <div class="col-sm-4">
                            <input type="text" class="form-control" id="no_rangka_input" name="no_rangka_input" :minlength="17" :maxlength="17" required v-model="customer.no_rangka" :readonly="edit_cust==''">
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
                        <div class="form-input">
                          <label for="inputEmail3" class="col-sm-2 control-label">Tahun Produksi <i style="color: red">*</i></label>
                          <div class="col-sm-4">
                            <input type="text" class="form-control" v-model="customer.tahun_produksi" :readonly="edit_cust==''" onkeypress="return number_only(event)" name='tahun_produksi' required>
                          </div>
                        </div>
                        <div class="form-input">
