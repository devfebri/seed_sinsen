                  ...
                  <div class="row" v-if="mode!='detail_nsc'">
                    <div class="col-sm-12">
                      <div class="callout callout-danger">
                        ...
                        <p style='font-size:11pt !important'>- Terdapat perbedaan item SO dan PO, yaitu:</p>
                        <ol v-for="prt_po in data_po">
                          <li>{{prt_po.id_part}} - {{prt_po.nama_part}}</li>
                        </ol>
                      </div>
                    </div>
                  </div>
            ...
            $.ajax({
              ...
              success: function(response) {
                ...
                if (response.status == 'sukses') {
                  ...
                  //! febri:  query diambil dari view\dealer\M_H2_api.php num 1143
                  form_.data_po = response.data_po;
                  //! end edit
