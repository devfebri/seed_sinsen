 <div v-if='target_salesman.jenis_target_salesman == "Parts"'>
     <table class="table">
         <tr>
             ...
             <td width='15%'>Target Part (Selling)</td>
             <td width='15%'>Target Part (Cost)</td>
             <td width="3%"></td>
         ...
         <tr v-if="target_salesman_parts.length > 0" v-for="(target_salesman_part, index) of filtered_target_salesman_parts">
             ...
             <td>
                 <vue-numeric v-if='target_salesman_part.global == 1' :read-only='mode == "detail"' class="form-control" currency="Rp" separator="." v-model='target_salesman_part.cost_target_part'></vue-numeric>
                 <vue-numeric v-if='target_salesman_part.global == 0' read-only class="form-control" currency="Rp" separator="." v-model='cost_total_target_parts_per_dealer(target_salesman_part)'></vue-numeric>
             </td>
             <td>
