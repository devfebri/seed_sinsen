<div v-if='target_salesman_selling_price.jenis_target_salesman_selling_price == "Apparel"'>
    <table class="table table-condensed">
        ...
        <tr v-if="target_salesman_selling_price_apparel.length > 0" v-for="(apparel, index) of filtered_target_salesman_selling_price_apparel">
            <td>{{ index + 1 }}.</td>
            ...
            <td v-if='mode != "detail"'>
                <button class="btn btn-flat btn-sm btn-danger" @click.prevent='hapus_target_salesman_selling_price_apparel(index)'><i class="fa fa-trash-o"></i></button>
            </td>
        </tr>
        <tr v-if="filtered_target_salesman_selling_price_apparel.length < 1">
