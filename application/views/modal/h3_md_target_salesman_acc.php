<div v-if='target_salesman.jenis_target_salesman == "Acc"'>
    <table class="table table-condensed">
        <tr>
            ...
            <td>Alamat</td>
            <td>Kabupaten</td>
            <td width='20%'>Target Accessories (Selling)</td>
            <td width='20%'>Target Accessories (Cost)</td>
        ...
        <tr v-if="target_salesman_acc.length > 0" v-for="(acc, index) of filtered_target_salesman_acc">
            ...
            <td>
                <vue-numeric :read-only='mode == "detail"' class="form-control" currency="Rp" separator="." v-model='acc.cost_target_acc'></vue-numeric>
            </td>
            <td v-if='mode != "detail"'>
