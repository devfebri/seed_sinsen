<div v-if='target_salesman.jenis_target_salesman == "Apparel"'>
    <table class="table table-condensed">
        <tr>
            ...
            <td>Alamat</td>
            <td>Kabupaten</td>
            <td width='20%'>Target Apparel (Selling)</td>
            <td width='20%'>Target Apparel (Cost)</td>
        ...
        <tr v-if="target_salesman_apparel.length > 0" v-for="(apparel, index) of filtered_target_salesman_apparel">
            ...
            <td>
                <vue-numeric :read-only='mode == "detail"' class="form-control" currency="Rp" separator="." v-model='apparel.cost_target_apparel'></vue-numeric>
            </td>
            <td v-if='mode != "detail"'>
