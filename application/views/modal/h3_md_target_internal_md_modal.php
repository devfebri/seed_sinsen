...
<table class="table">
    ...
    <tr v-if="target_dealer_detail.length > 0" v-for="(target_dealer_det, index) of target_dealer_detail">
        ...
        <td>
            <vue-numeric :read-only='mode == "detail"' class="form-control" currency="Rp" separator="." v-model='target_dealer_det.target_dealer_sales_in'></vue-numeric>
        </td>
        <td>
            <vue-numeric :read-only='mode == "detail"' class="form-control" currency="Rp" separator="." v-model='target_dealer_det.target_dealer_sales_out'></vue-numeric>
        </td>
        <td>
