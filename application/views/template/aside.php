    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="
            ...
            ?>
	  ">
          <a href="panel/welcome"><i class="fa fa-home"></i> <span>Home</span></a>
        </li>
    ...
    <section class="sidebar">
	  ...
	  ">
        ...
        <li class="
          ...
          ?>
          <a href="panel/home"><i class="fa fa-home"></i> <span>Dashboard</span></a>
        </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        $aside = $this->db->query('
			select mm.id_menu, mmh.menu_header,mm.menu_name,mm.menu_link, mm.status 
			from ms_menu_header mmh 
          join ms_menu mm on mm.id_menu_header = mmh.id_menu_header
          WHERE mm.id_menu_header in (4,3)')->result_array();
        // var_dump()
        ?>

        <!-- <form action="#" method="get" class="sidebar-form"> -->
        <div class="input-group sidebar-form">
          <input type="text" id="input_box" class="form-control" placeholder="Cari Menu . . ." value="" autocomplete="off">
        ...
        <script type="text/javascript">
          let availableKeywords = [
            <?php
            foreach ($aside as $r) { ?> '<?php echo $r['menu_name']; ?>',
            <?php
            };
            ?>
          ];
          ...
          let array = <?php echo json_encode($aside); ?>;
          var availableKeywords1 = array.map(function(value, index) {
            value['id_menu'];
            value['menu_header'];
            value['menu_name'];
            value['menu_link'];
          ...
          inputBox.onkeyup = function() {
            ...
            if (input.length) {
              result = availableKeywords1.filter((keyword => {
                return keyword.menu_name.toLowerCase().includes(input.toLowerCase());
              }));
          ...
          function display(result) {
            ...
            const content = result.map((list) => {
              // console.log(list);
              return "<li id='" + list.id_menu + "' onclick=selectInput(this) value='/" + list.menu_header + "/" + list.menu_link + "'><a href='/" + list.menu_header.toLowerCase() + "/" + list.menu_link + "'>" + list.menu_name + "</a></li>";
            })
          ...
          function selectInput(list) {
            // console.log(list);
            var link = $(this).closest('li').data('value');
            // console.log($(this).attr('id'));
            // console.log(event.target.value);

            // window.location.href = 'h3/kelompok_part';
