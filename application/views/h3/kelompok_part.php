                      ...
                      <div class="col-sm-12 no-padding">
                        <table class="table table-condensed">
                          <tr>
                            ...
                            <td v-if='mode != "detail"' width='3%'><button class="btn btn-flat btn-danger btn-sm" @click.prevent='delete_all(items.length)'><i class="fa fa-trash-o"></i> Delete All</button></td>
                          </tr>
                          <tr v-if='items.length > 0' v-for='(item, index) of filtered_items'>
                            ...
                            <td>
                              {{item.m_6+item.m_5+item.m_4+item.m_3+item.m_2+item.m_1}}
                            </td>
                            <td>
