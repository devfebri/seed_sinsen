...
<body>
    ...
    <table class="table" style='margin-bottom: 20px;'>
        <tr>
            <td class='text-center text-bold' style='font-size: 16px;'>Faktur Penjualan
            <td>
        </tr>
    </table>
    <table class="table">
    ...
    <table style="margin-top: 70px;" class="table"> 
        <tr>
            <td width="33.33%" class="text-center">( Drs. Tony Attan, SH )</td>
            <td width="33.33%" class="text-center"></td>
            <td width="33.33%" class="text-center">( Mario )</td>
        </tr>
    </table>
</body>
