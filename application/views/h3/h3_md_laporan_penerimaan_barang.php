...
<div class="content-wrapper">
  ...
  <section class="content">
                ...
                <div class="box-body">
                  ...
                  <div class="container-fluid" v-if='mode != "detail"'>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 text-right">
                        <paginate v-if="mode === 'edit_non_ev'" v-model='page' :page-count="jumlah_page" :page-range="3" :click-handler="set_page" :prev-text="'Prev'" :next-text="'Next'" :container-class="'pagination'">
                        </paginate>

                        <paginate v-if="mode === 'edit_ev'" v-model='page2' :page-count="jumlah_page2" :page-range="3" :click-handler="set_page2" :prev-text="'Prev'" :next-text="'Next'" :container-class="'pagination'">
                        </paginate>
                      </div>
                    </div>
                  </div>
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">
            ...
            <a href="h3/<?= $isi ?>/cekbarang">
              <button class="btn bg-yellow btn-flat margin"> Cek Barang</button>
            </a>
          </h3>
        </div><!-- /.box-header -->
        <script>
    ...
    <?php } else if ($set == "cekbarang") {
    ?>
      <div id="form_" class="box">
        <div class="box-header with-border">
          <h3 class="box-title">
            <a href="h3/<?= $isi ?>">
              <button class="btn bg-maroon btn-flat margin"><i class="fa fa-eye"></i> View Data</button>
          ...
          <script>
            ...
            $(document).ready(function() {
              ...
              barang_belum_dicek = $('#barang_belum_dicek').DataTable({
                ...
                order: [],
                ajax: {
                  url: "<?= base_url('api/md/h3/barang_cek') ?>",
                  dataSrc: 'data',
                  type: "POST",
                  data: function(d) {
