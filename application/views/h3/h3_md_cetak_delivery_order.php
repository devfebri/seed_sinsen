...
<body>
    ...
    <table class="table" style='margin-bottom: 10px;'>
        <tr>
            <td class='text-center text-bold' style='font-size: 16px;'>DELIVERY ORDER
            <td>
        </tr>
    </table>
    <!-- <table class="table">
    ...
    <table style="margin-top: 70px;" class="table">
        <tr>
            <td width="33.33%" class="text-center"><?= $dibuat_oleh ?></td>
            <td width="33.33%" class="text-center">Harianto Hygens</td>
            <td width="33.33%" class="text-center"><?= $do_sales_order['nama_dealer'] ?></td>
        </tr>
    </table>
</body>
