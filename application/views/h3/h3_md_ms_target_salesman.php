            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  <label class="col-sm-4 control-label">Nama Salesman </label>
                  <div class="col-sm-8">
                    <div class="input-group" v-bind:class="{ 'has-error': error_exist('id_salesman') }">
                ...
                <div class="form-group">
                  ...
                  <div v-bind:class="{ 'has-error': error_exist('start_date') || error_exist('end_date') }" class="col-sm-8">
                ...
                <div class="form-group">
                  <label class="control-label col-sm-4">Target Salesman Global (Selling)</label>
                  <div class="col-sm-8">
                ...
                <div class="form-group">
                  <label class="control-label col-sm-4">Target Salesman Per Channel (Selling)</label>
                  <div class="col-sm-8">
                    <vue-numeric disabled class="form-control" v-model='target_salesman_channel' separator='.' currency='Rp'></vue-numeric>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-4">Target Salesman Global Cost (Selling)</label>
                  <div class="col-sm-8">
                    <vue-numeric class="form-control" :disabled='mode == "detail"' v-model='target_salesman.target_salesman_global_cost' separator='.' currency='Rp'></vue-numeric>
                  </div>
                </div>
                <div class="form-group" v-if='target_salesman.jenis_target_salesman == "Oil"'>
                  <label class="control-label col-sm-4">Target Salesman Dus Global (Selling)</label>
                  <div class="col-sm-8">
                    <vue-numeric :disabled='mode == "detail"' class="form-control" v-model='target_salesman.target_salesman_dus_global' separator='.' currency='Rp'></vue-numeric>
                  </div>
                </div>
                <div class="form-group" v-if='target_salesman.jenis_target_salesman == "Oil"'>
                  <label class="control-label col-sm-4">Target Salesman Dus Per Channel (Selling)</label>
                  <div class="col-sm-8">
                    <vue-numeric disabled class="form-control" v-model='target_salesman_dus_channel' separator='.' currency='Rp'></vue-numeric>
                  </div>
                </div>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-4 control-label">NIK Salesman</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" readonly v-model='target_salesman.nik_salesman'>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-4">Jenis Target Salesman</label>
                  <div class="col-sm-8">
                ...
                <div class="form-group">
                  <label class="control-label col-sm-4">Target Salesman Global (Cost)</label>
                  <div class="col-sm-8">
                    <vue-numeric :disabled='mode == "detail"' class="form-control" v-model='target_salesman.cost_target_salesman_global' separator='.' currency='Rp'></vue-numeric>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-4">Target Salesman Per Channel (Cost)</label>
                  <div class="col-sm-8">
                    <vue-numeric disabled class="form-control" v-model='cost_target_salesman_channel' separator='.' currency='Rp'></vue-numeric>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-4">Target Salesman Global Cost (Cost)</label>
                  <div class="col-sm-8">
                    <vue-numeric class="form-control" :disabled='mode == "detail"' v-model='target_salesman.cost_target_salesman_global_cost' separator='.' currency='Rp'></vue-numeric>
                  </div>
                </div>
                <div class="form-group" v-if='target_salesman.jenis_target_salesman == "Oil"'>
                  <label class="control-label col-sm-4">Target Salesman Dus Global (Cost)</label>
                  <div class="col-sm-8">
                    <vue-numeric :disabled='mode == "detail"' class="form-control" v-model='target_salesman.cost_target_salesman_dus_global' separator='.' currency='Rp'></vue-numeric>
                  </div>
                </div>
                <div class="form-group" v-if='target_salesman.jenis_target_salesman == "Oil"'>
                  <label class="control-label col-sm-4">Target Salesman Dus Per Channel (Cost)</label>
                  <div class="col-sm-8">
                    <vue-numeric disabled class="form-control" v-model='cost_target_salesman_dus_channel' separator='.' currency='Rp'></vue-numeric>
                  </div>
                </div>
      ...
      <script>
        app = new Vue({
          ...
          data: {
            ...
            <?php else : ?>
              target_salesman: {
                ...
                target_salesman_global_cost: '',
                cost_target_salesman_global: '',
                cost_target_salesman_global_cost: '',
              },
          ...
          methods: {
            <?= $form ?>: function() {
              ...
              post = _.pick(this.target_salesman, [
                'id', 'id_salesman', 'start_date', 'end_date', 'jenis_target_salesman',
                'target_salesman_global', 'target_salesman_global_cost', 'target_salesman_dus_global',
                'cost_target_salesman_global', 'cost_target_salesman_global_cost', 'cost_target_salesman_dus_global',
              ]);

              post.target_salesman_channel = this.target_salesman_channel;
              post.cost_target_salesman_channel = this.cost_target_salesman_channel;
              post.target_salesman_dus_channel = this.target_salesman_dus_channel;
              post.cost_target_salesman_dus_channel = this.cost_target_salesman_dus_channel;
              ...
              post.cost_target_salesman_parts = _.map(this.cost_target_salesman_parts, function(i) {
                if (i.global == 0) {
                  i.cost_target_part = app.cost_total_target_parts_per_dealer(i);
                }
                return i;
              });
              ...
              post.target_salesman_oils = _.map(this.target_salesman_oils, function(i) {
                ...
                i.cost_total_amount = app.cost_hitung_amount_target_salesman_oil(i);
                i.cost_total_botol = app.cost_hitung_botol_target_salesman_oil(i);
                return i;
              });
            ...
            cost_total_target_parts_per_dealer: function(data) {
              return _.sumBy(data.items, function(item) {
                return Number(item.cost_target_part_items);
              });
            },
            ...
            cost_hitung_amount_target_salesman_oil: function(data) {
              return data.cost_amount_engine_oil + data.cost_amount_gear_oil;
            },
            cost_hitung_botol_target_salesman_oil: function(data) {
              return data.cost_botol_engine_oil + data.cost_botol_gear_oil;
            },
          ...
          computed: {
            ...
            cost_target_salesman_channel: function() {
              if (this.target_salesman.jenis_target_salesman == 'Parts') {
                return _.sumBy(this.target_salesman_parts, function(i) {
                  if (i.global == 1) {
                    return parseInt(i.cost_target_part);
                  }
                  return _.sumBy(i.items, function(item) {
                    return parseInt(item.cost_target_part_items);
                  });
                });
              }
              ...
              if (this.target_salesman.jenis_target_salesman == 'Oil') {
                return _.sumBy(this.target_salesman_oils, function(i) {
                  return parseInt(i.cost_amount_engine_oil) + parseInt(i.cost_amount_gear_oil);
                });
              }

              if (this.target_salesman.jenis_target_salesman == 'Acc') {
                return _.sumBy(this.target_salesman_acc, function(i) {
                  return parseInt(i.cost_target_acc);
                });
              }

              if (this.target_salesman.jenis_target_salesman == 'Apparel') {
                return _.sumBy(this.target_salesman_apparel, function(i) {
                  return parseInt(i.cost_target_apparel);
                });
              }
              return 0;
            },
            ...
            cost_target_salesman_dus_channel: function() {
              if (this.target_salesman.jenis_target_salesman == 'Oil') {
                return _.sumBy(this.target_salesman_oils, function(i) {
                  return (i.cost_botol_engine_oil / 24) + (i.cost_botol_gear_oil / 48);
                });
              }
              return 0;
            },
            cost_total_botol: function() {
              if (this.target_salesman.jenis_target_salesman == 'Oil') {
                return _.sumBy(this.target_salesman_oils, function(i) {
                  return i.cost_botol_engine_oil + i.cost_botol_gear_oil;
                });
              }
              return 0;
            },
    ...
    ?>
      <div class="box">
        ...
        <div class="box-body">
          ...
          <table id="master_target_salesman" class="table table-bordered table-hover table-condensed text-center align-center">
            <thead>
              <tr>
                <th rowspan="2">No.</th>
                <th rowspan="2">Salesman</th>
                <th rowspan="2">Jenis Target Salesman</th>
                <th rowspan="2">Periode awal</th>
                <th rowspan="2">Periode akhir</th>
                <th colspan="2">Target Salesman Global</th>
                <th colspan="2">Target Salesman Per Channel</th>
                <th colspan="2">Target Salesman Global Cost</th>
            ...
            $(document).ready(function() {
              master_target_salesman = $('#master_target_salesman').DataTable({
                ...
                columns: [{
                  ...
                  {
                    data: 'cost_target_salesman_global',
                    render: rupiah_render
                  },
                  {
                  ...
                  {
                    data: 'cost_target_salesman_channel',
                    render: rupiah_render
                  },
                  {
                    data: 'target_salesman_global_cost',
                    render: rupiah_render
                  },
                  {
                    data: 'cost_target_salesman_global_cost',
                    render: rupiah_render
                  },
                  {
                    data: 'action',
