...
<body>
    ...
    <?php $total_parts += $packing_sheet['parts'];
                $total_ban += $packing_sheet['ban'];
                $total_oil += $packing_sheet['oil'];
                $index++;
            endforeach; ?>
    </tr>
    <tr>
    ...
    <table style="margin-top: 40px;" class="table">
        <tr>
            <td width="33.33%" class="text-center">PT.Sinar Sentosa Primatama</td>
    ...
    <table style="margin-top: 70px;" class="table">
        <tr>
            <td width="33.33%" class="text-center"> Fuji Astuti </td>
            <td width="33.33%" class="text-center"> Harianto Hygens </td>
            <td width="33.33%" class="text-center"> <?= $surat_pengantar['nama_ekspedisi'] ?> </td>
        </tr>
    </table>
</body>
