            ...
            <div class="col-md-12">
              <form class="form-horizontal">
                <div class="box-body">
                  ...
                  <?php $this->load->view('modal/h3_md_target_sales_in_dealer_modal') ?>
                  <?php $this->load->view('modal/h3_dealer_target_sales_in') ?>
                  <script>
                    function pilih_dealer_target_sales_in(data) {
                      data = _.pick(data, ['id_dealer', 'kode_dealer_md', 'nama_dealer', 'alamat', 'kabupaten']);
                      app.target_dealer_detail.push(data);

                      h3_dealer_target_sales_in_datatable.draw();
                    }
                  </script>
      ...
      <script>
        app = new Vue({
          ...
          methods: {
            ...
            open_dealer_target_sales_in: function(dealer_modal_type) {
              this.dealer_modal_type = dealer_modal_type;
              $('#h3_dealer_target_sales_in_datatable').modal('show');
            },
