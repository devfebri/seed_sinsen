              ...
              <div class="col-md-12">
                <form class="form-horizontal">
                        ...
                        <table id="table" class="table table-condensed table-responsive table-bordered">
                          ...
                          <tbody>
                            <tr v-for="(part, index) in parts">
                              ...
                              <td class="align-middle">{{ part.produk }}</td>
                  ...
                  <div class="box-footer">
                    ...
                    <div class="col-sm-2 text-right no-padding" v-if='mode == "detail"'>
                      <select class="form-control" name="kelProduk" @change="onChange($event)" v-model="selected_kel_part">
                        <option v-for="(kel_part,index) in kel_parts" v-bind:value="kel_part.produk" v-if='kel_part.hasil != 0'>{{kel_part.produk}}</option>
                      </select>
                    </div>
                    <div class="col-sm-2 text-right no-padding">
                      <a v-if='mode == "detail"' :href="'h3/h3_md_sales_order/add?generateByPO=true&kel_part='+selected_kel_part+'&po_id=' + purchase.po_id" :class='{ "disabled": tidak_boleh_proses_so }' target="_blank" class="btn btn-flat btn-sm btn-info" role='button'>
                        Create SO
                      </a>
                    </div>
                  </div><!-- /.box-footer -->
        ...
        <script>
          app = new Vue({
            ...
            data: {
              ...
              kel_parts: <?= json_encode($kel_parts) ?>,
              selected_kel_part: "",
            },
            methods: {
              <?= $form ?>: function() {
                ...
                // post = _.pick(this.purchase, ['kel_part']);
