...
<table border="1">
	...
	<tr>
		<?php 
			...
			if($laporan_sales_by_channel_target_oli_m1_cost->row()->h123 !=0){
				$ach_cost_oli_m1_h123 = round(($laporan_sales_by_channel_cost_price_oil_m1->row()->h123 / $laporan_sales_by_channel_target_oli_m1_cost->row()->h123)*100);
			}else{
				$ach_cost_oli_m1_h123 = 0;
			}

			if($laporan_sales_by_channel_target_oli_m_cost->row()->h123 !=0){
				$ach_cost_oli_m_h123= round(($laporan_sales_by_channel_cost_price_oil_m->row()->h123 / $laporan_sales_by_channel_target_oli_m_cost->row()->h123)*100);
			}else{
				$ach_cost_oli_m_h123 = 0;
			}
		...
		<td style="vertical-align : middle;text-align:center;"><?php echo number_format($laporan_sales_by_channel_target_oli_m1_cost->row()->h123, 0, ',', '.');?></td>
		...
		<td style="vertical-align : middle;text-align:center;"><?php echo number_format($laporan_sales_by_channel_target_oli_m_cost->row()->h123, 0, ',', '.') ;?></td>
	...
	<tr>
		<?php 
			...
			if($laporan_sales_by_channel_target_oli_m1_cost->row()->h23 !=0){
				$ach_cost_oli_m1_h23 = round(($laporan_sales_by_channel_cost_price_oil_m1->row()->h23 / $laporan_sales_by_channel_target_oli_m1_cost->row()->h23)*100);
			}else{
				$ach_cost_oli_m1_h23 = 0;
			}

			if($laporan_sales_by_channel_target_oli_m_cost->row()->h23 !=0){
				$ach_cost_oli_m_h23 = round(($laporan_sales_by_channel_cost_price_oil_m->row()->h23 / $laporan_sales_by_channel_target_oli_m_cost->row()->h23)*100);
			}else{
				$ach_cost_oli_m_h23 = 0;
			}
		...
		<td style="vertical-align : middle;text-align:center;"><?php echo number_format($laporan_sales_by_channel_target_oli_m1_cost->row()->h23, 0, ',', '.') ;?></td>
		...
		<td style="vertical-align : middle;text-align:center;"><?php echo number_format($laporan_sales_by_channel_target_oli_m_cost->row()->h23, 0, ',', '.');?></td>
	...
	<tr>
		<?php 
			...
			if($laporan_sales_by_channel_target_oli_m1_cost->row()->h3 !=0){
				$ach_cost_oli_m1_h3 = round(($laporan_sales_by_channel_cost_price_oil_m1->row()->h3 / $laporan_sales_by_channel_target_oli_m1_cost->row()->h3)*100);
			}else{
				$ach_cost_oli_m1_h3 = 0;
			}

			if($laporan_sales_by_channel_target_oli_m_cost->row()->h3 !=0){
				$ach_cost_oli_m_h3 = round(($laporan_sales_by_channel_cost_price_oil_m->row()->h3 / $laporan_sales_by_channel_target_oli_m_cost->row()->h3)*100);
			}else{
				$ach_cost_oli_m_h3 = 0;
			}
		...
		<td style="vertical-align : middle;text-align:center;"><?php echo number_format($laporan_sales_by_channel_target_oli_m1_cost->row()->h3, 0, ',', '.') ;?></td>
		...
		<td style="vertical-align : middle;text-align:center;"><?php echo number_format($laporan_sales_by_channel_target_oli_m_cost->row()->h3, 0, ',', '.');?></td>
	...
	<tr>
		<?php 
			...
			$total_cost_price_target_m1 = ($laporan_sales_by_channel_target_oli_m1_cost->row()->h123+$laporan_sales_by_channel_target_oli_m1_cost->row()->h23+$laporan_sales_by_channel_target_oli_m1_cost->row()->h3);
			...
			$total_cost_price_target_m = ($laporan_sales_by_channel_target_oli_m_cost->row()->h123+$laporan_sales_by_channel_target_oli_m_cost->row()->h23+$laporan_sales_by_channel_target_oli_m_cost->row()->h3);
...
<table border="1">
	...
	<tr>
		<?php 
			...
			if($laporan_sales_by_channel_target_oli_m1_selling->row()->h123 !=0){
				$ach_oli_selling_m1_h123 = round(($laporan_sales_by_channel_selling_price_oil_m1->row()->h123 / $laporan_sales_by_channel_target_oli_m1_selling->row()->h123)*100);
			}else{
				$ach_oli_selling_m1_h123 = 0;
			}

			if($laporan_sales_by_channel_target_oli_m_selling->row()->h123 !=0){
				$ach_oli_selling_m_h123 = round(($laporan_sales_by_channel_selling_price_oil_m->row()->h123 / $laporan_sales_by_channel_target_oli_m_selling->row()->h123)*100);
			}else{
				$ach_oli_selling_m_h123 = 0;
			}
		...
		<td style="vertical-align : middle;text-align:center;">1</td>
		<td style="vertical-align : middle;text-align:center;">H123</td>
		<td style="vertical-align : middle;text-align:center;"><?php echo number_format($laporan_sales_by_channel_target_oli_m1_selling->row()->h123, 0, ',', '.') ;?></td>
		...
		<td style="vertical-align : middle;text-align:center;"><?php echo number_format($laporan_sales_by_channel_target_oli_m_selling->row()->h123, 0, ',', '.');?></td>
	...
	<tr>
		<?php 
			...
			if($laporan_sales_by_channel_target_oli_m1_selling->row()->h23 !=0){
				$ach_oli_selling_m1_h23 = round(($laporan_sales_by_channel_selling_price_oil_m1->row()->h23 / $laporan_sales_by_channel_target_oli_m1_selling->row()->h23)*100);
			}else{
				$ach_oli_selling_m1_h23 = 0;
			}

			if($laporan_sales_by_channel_target_oli_m_selling->row()->h23 !=0){
				$ach_oli_selling_m_h23 = round(($laporan_sales_by_channel_selling_price_oil_m->row()->h23 / $laporan_sales_by_channel_target_oli_m_selling->row()->h23)*100);
			}else{
				$ach_oli_selling_m_h23 = 0;
			}
		...
		<td style="vertical-align : middle;text-align:center;">2</td>
		<td style="vertical-align : middle;text-align:center;">H23</td>
		<td style="vertical-align : middle;text-align:center;"><?php echo number_format($laporan_sales_by_channel_target_oli_m1_selling->row()->h23, 0, ',', '.');?></td>
		...
		<td style="vertical-align : middle;text-align:center;"><?php echo number_format($laporan_sales_by_channel_target_oli_m_selling->row()->h23, 0, ',', '.');?></td>
	...
	<tr>
		<?php 
			...
			if($laporan_sales_by_channel_target_oli_m1_selling->row()->h3 !=0){
				$ach_oli_selling_m1_h3 = round(($laporan_sales_by_channel_selling_price_oil_m1->row()->h3 / $laporan_sales_by_channel_target_oli_m1_selling->row()->h3)*100);
			}else{
				$ach_oli_selling_m1_h3 = 0;
			}

			if($laporan_sales_by_channel_target_oli_m_selling->row()->h3 !=0){
				$ach_oli_selling_m_h3 = round(($laporan_sales_by_channel_selling_price_oil_m->row()->h3 / $laporan_sales_by_channel_target_oli_m_selling->row()->h3)*100);
			}else{
				$ach_oli_selling_m_h3 = 0;
			}
		...
		<td style="vertical-align : middle;text-align:center;">3</td>
		<td style="vertical-align : middle;text-align:center;">H3</td>
		<td style="vertical-align : middle;text-align:center;"><?php echo number_format($laporan_sales_by_channel_target_oli_m1_selling->row()->h3, 0, ',', '.');?></td>
		...
		<td style="vertical-align : middle;text-align:center;"><?php echo number_format($laporan_sales_by_channel_target_oli_m_selling->row()->h3, 0, ',', '.') ;?></td>
	...
	<tr>
		<?php 
			...
			$total_selling_price_target_m1 = ($laporan_sales_by_channel_target_oli_m1_selling->row()->h123+$laporan_sales_by_channel_target_oli_m1_selling->row()->h23+$laporan_sales_by_channel_target_oli_m1_selling->row()->h3);
			...
			$total_selling_price_target_m = ($laporan_sales_by_channel_target_oli_m_selling->row()->h123+$laporan_sales_by_channel_target_oli_m_selling->row()->h23+$laporan_sales_by_channel_target_oli_m_selling->row()->h3);
...
<table border="1">
	...
	<tr>
		<?php 
			...
			if($laporan_sales_by_channel_target_part_m1_cost->row()->h123 !=0){
				$ach_cost_part_m1_h123 = round(($laporan_sales_by_channel_cost_price_part_m1->row()->h123 / $laporan_sales_by_channel_target_part_m1_cost->row()->h123)*100);
			}else{
				$ach_cost_part_m1_h123 = 0;
			}

			if($laporan_sales_by_channel_target_part_m_cost->row()->h123 !=0){
				$ach_cost_part_m_h123 = round(($laporan_sales_by_channel_cost_price_part_m->row()->h123 / $laporan_sales_by_channel_target_part_m_cost->row()->h123)*100);
			}else{
				$ach_cost_part_m_h123 = 0;
			}
		...
		<td style="vertical-align : middle;text-align:center;">1</td>
		<td style="vertical-align : middle;text-align:center;">H123</td>
		<td style="vertical-align : middle;text-align:center;"><?php echo number_format($laporan_sales_by_channel_target_part_m1_cost->row()->h123, 0, ',', '.')  ;?></td>
		...
		<td style="vertical-align : middle;text-align:center;"><?php echo  number_format($laporan_sales_by_channel_target_part_m_cost->row()->h123, 0, ',', '.');?></td>
	...
	<tr>
		<?php 
			...
			if($laporan_sales_by_channel_target_part_m1_cost->row()->h23 !=0){
				$ach_cost_part_m1_h23 = round(($laporan_sales_by_channel_cost_price_part_m1->row()->h23 / $laporan_sales_by_channel_target_part_m1_cost->row()->h23)*100);
			}else{
				$ach_cost_part_m1_h23 = 0;
			}

			if($laporan_sales_by_channel_target_part_m_cost->row()->h23 !=0){
				$ach_cost_part_m_h23 = round(($laporan_sales_by_channel_cost_price_part_m->row()->h23 / $laporan_sales_by_channel_target_part_m_cost->row()->h23)*100);
			}else{
				$ach_cost_part_m_h23 = 0;
			}
		...
		<td style="vertical-align : middle;text-align:center;">2</td>
		<td style="vertical-align : middle;text-align:center;">H23</td>
		<td style="vertical-align : middle;text-align:center;"><?php echo number_format($laporan_sales_by_channel_target_part_m1_cost->row()->h23, 0, ',', '.') ;?></td>
		...
		<td style="vertical-align : middle;text-align:center;"><?php echo number_format($laporan_sales_by_channel_target_part_m_cost->row()->h23, 0, ',', '.') ;?></td>
	...
	<tr>
		<?php 
			...
			if($laporan_sales_by_channel_target_part_m1_cost->row()->h3 !=0){
				$ach_cost_part_m1_h3 = round(($laporan_sales_by_channel_cost_price_part_m1->row()->h3 / $laporan_sales_by_channel_target_part_m1_cost->row()->h3)*100);
			}else{
				$ach_cost_part_m1_h3 = 0;
			}

			if($laporan_sales_by_channel_target_part_m_cost->row()->h3 !=0){
				$ach_cost_part_m_h3 = round(($laporan_sales_by_channel_cost_price_part_m->row()->h3 / $laporan_sales_by_channel_target_part_m_cost->row()->h3)*100);
			}else{
				$ach_cost_part_m_h3 = 0;
			}
		...
		<td style="vertical-align : middle;text-align:center;">3</td>
		<td style="vertical-align : middle;text-align:center;">H3</td>
		<td style="vertical-align : middle;text-align:center;"><?php echo number_format($laporan_sales_by_channel_target_part_m1_cost->row()->h3, 0, ',', '.') ;?></td>
		...
		<td style="vertical-align : middle;text-align:center;"><?php echo number_format($laporan_sales_by_channel_target_part_m_cost->row()->h3, 0, ',', '.');?></td>
	...
	<tr>
		<?php 
			...
			$total_cost_price_part_target_m1 = ($laporan_sales_by_channel_target_part_m1_cost->row()->h123+$laporan_sales_by_channel_target_part_m1_cost->row()->h23+$laporan_sales_by_channel_target_part_m1_cost->row()->h3);
			...
			$total_cost_price_part_target_m = ($laporan_sales_by_channel_target_part_m_cost->row()->h123+$laporan_sales_by_channel_target_part_m_cost->row()->h23+$laporan_sales_by_channel_target_part_m_cost->row()->h3);
...
<table border="1">
	...
	<tr>
		<?php 
			...
			if($laporan_sales_by_channel_target_part_m1_selling->row()->h123 !=0){
				$ach_part_selling_m1_h123 = round(($laporan_sales_by_channel_selling_price_part_m1->row()->h123 / $laporan_sales_by_channel_target_part_m1_selling->row()->h123)*100);
			}else{
				$ach_part_selling_m1_h123 = 0;
			}

			if($laporan_sales_by_channel_target_part_m_selling->row()->h123 !=0){
				$ach_part_selling_m_h123 = round(($laporan_sales_by_channel_selling_price_part_m->row()->h123 / $laporan_sales_by_channel_target_part_m_selling->row()->h123)*100);
			}else{
				$ach_part_selling_m_h123 = 0;
			}
		...
		<td style="vertical-align : middle;text-align:center;">1</td>
		<td style="vertical-align : middle;text-align:center;">H123</td>
		<td style="vertical-align : middle;text-align:center;"><?php echo number_format($laporan_sales_by_channel_target_part_m1_selling->row()->h123, 0, ',', '.') ;?></td>
		...
		<td style="vertical-align : middle;text-align:center;"><?php echo number_format($laporan_sales_by_channel_target_part_m_selling->row()->h123, 0, ',', '.');?></td>
	...
	<tr>
		<?php 
			...
			if($laporan_sales_by_channel_target_part_m1_selling->row()->h23 !=0){
				$ach_part_selling_m1_h23 = round(($laporan_sales_by_channel_selling_price_part_m1->row()->h23 / $laporan_sales_by_channel_target_part_m1_selling->row()->h23)*100);
			}else{
				$ach_part_selling_m1_h23 = 0;
			}

			if($laporan_sales_by_channel_target_part_m_selling->row()->h23 !=0){
				$ach_part_selling_m_h23 = round(($laporan_sales_by_channel_selling_price_part_m->row()->h23 / $laporan_sales_by_channel_target_part_m_selling->row()->h23)*100);
			}else{
				$ach_oli_selling_m_h23 = 0;
			}
		...
		<td style="vertical-align : middle;text-align:center;">2</td>
		<td style="vertical-align : middle;text-align:center;">H23</td>
		<td style="vertical-align : middle;text-align:center;"><?php echo number_format($laporan_sales_by_channel_target_part_m1_selling->row()->h23, 0, ',', '.') ;?></td>
		...
		<td style="vertical-align : middle;text-align:center;"><?php echo  number_format($laporan_sales_by_channel_target_part_m_selling->row()->h23, 0, ',', '.');?></td>
	...
	<tr>
		<?php 
			...
			if($laporan_sales_by_channel_target_part_m1_selling->row()->h3 !=0){
				$ach_part_selling_m1_h3 = round(($laporan_sales_by_channel_selling_price_part_m1->row()->h3 / $laporan_sales_by_channel_target_part_m1_selling->row()->h3)*100);
			}else{
				$ach_part_selling_m1_h3 = 0;
			}

			if($laporan_sales_by_channel_target_part_m_selling->row()->h3 !=0){
				$ach_part_selling_m_h3 = round(($laporan_sales_by_channel_selling_price_part_m->row()->h3 / $laporan_sales_by_channel_target_part_m_selling->row()->h3)*100);
			}else{
				$ach_part_selling_m_h3 = 0;
			}
		...
		<td style="vertical-align : middle;text-align:center;">3</td>
		<td style="vertical-align : middle;text-align:center;">H3</td>
		<td style="vertical-align : middle;text-align:center;"><?php echo number_format($laporan_sales_by_channel_target_part_m1_selling->row()->h3, 0, ',', '.');?></td>
		...
		<td style="vertical-align : middle;text-align:center;"><?php echo number_format($laporan_sales_by_channel_target_part_m_selling->row()->h3, 0, ',', '.') ;?></td>
	...
	<tr>
		<?php 
			...
			$total_selling_price_part_target_m1 = ($laporan_sales_by_channel_target_part_m1_selling->row()->h123+$laporan_sales_by_channel_target_part_m1_selling->row()->h23+$laporan_sales_by_channel_target_part_m1_selling->row()->h3);
			...
			$total_selling_price_part_target_m = ($laporan_sales_by_channel_target_part_m_selling->row()->h123+$laporan_sales_by_channel_target_part_m_selling->row()->h23+$laporan_sales_by_channel_target_part_m_selling->row()->h3);
