        ...
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">
              ...
              <a href="h3/h3_md_monitoring_outstanding/laporan" class="btn bg-blue btn-flat margin"><i class="fa fa-list"></i> Laporan</a>
            </h3>
          </div><!-- /.box-header -->
          <div class="box-body">
    ...
    <?php } elseif ($set == "laporan") { ?>
      <section class="content">
        <div class="box box-default">
          ...
          <form class="form-horizontal" id="frm" method="post" action="h3/h3_md_monitoring_outstanding/downloadReport" enctype="multipart/form-data">
