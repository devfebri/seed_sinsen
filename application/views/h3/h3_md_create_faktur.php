            ...
            <form class="form-horizontal">
              ...
              <div class="box-footer">
                ...
                <div class="col-sm-6 text-right">
                  <!-- edit by febri -->
                  <a :disabled='do_sales_order.selesai_scan == 0'  :href="'h3/h3_md_create_faktur/sendEmail?id=' + do_sales_order.id_do_sales_order" class='btn btn-flat btn-sm btn-primary'>Send Email</a>
