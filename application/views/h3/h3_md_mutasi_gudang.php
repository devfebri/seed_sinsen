                ...
                <form class="form-horizontal">
                  ...
                  <div class="box-footer">
                    <div class="col-sm-12 no-padding">
                      <!-- <a v-if="mode =='detail'" :href="'h3/<?= $isi ?>/edit?id_part=' + mutasi.id_part" class="btn btn-sm btn-flat btn-warning">Edit</a> -->
            ...
            methods: {
              <?= $form ?>: function() {
                ...
                axios.post('h3/<?= $isi ?>/<?= $form ?>', Qs.stringify(post))
                  .then(function(res) {
                    window.location = 'h3/h3_md_mutasi_gudang/riwayat_mutasi?id_part=' + res.data.id_part;
                  }).catch(function(err) {
      ...
      <?php if ($set == 'riwayat_mutasi') : ?>
        <div class="box box-default">
                ...
                <form class="form-horizontal">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <div class="input-group">
                          <input value="<?= $header['id_part'] ?>" readonly type="text" class="form-control">
                    ...
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Nama Part</label>
                      <div class="col-sm-4">
                        <input value="<?= $header['nama_part'] ?>" readonly type="text" class="form-control">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
          ...
          <div class="box-body">
            <div class="row">
              <div class="col-md-12">
                <table id="riwayat_mutasi" class="table table-bordered table-hover text-center">
                  <thead>
                    <tr>
                      <th rowspan="2">No.</th>
                      <th rowspan="2">No. Mutasi</th>
                      <th rowspan="2">Tanggal Mutasi</th>
                      <th colspan="2">Lokasi Awal</th>
                      <th colspan="2">Lokasi Tujuan</th>
                ...
                <script>
                  $(document).ready(function() {
                    ...
                    riwayat_mutasi = $('#riwayat_mutasi').DataTable({
                      processing: true,
                      serverSide: true,
                      scrollX: true,
                      orderr: [],
                      ajax: {
                        url: "<?= base_url('api/md/h3/mutasi_gudang_detail') ?>",
                        dataSrc: "data",
                        type: "POST",
                        data: function(data) {
                          data.header = <?= json_encode($header['id_part']) ?>;
                        }
                      },
                      columns: [{
                          data: null,
                    ...
                    // console.log(riwayat_mutasi)
                    riwayat_mutasi.on('draw.dt', function() {
                      var infos = riwayat_mutasi.page.info();
                      riwayat_mutasi.column(0, {
                        search: 'applied',
                        order: 'applied',
                        page: 'applied'
                      }).nodes().each(function(cell, i) {
                        cell.innerHTML = i + 1 + infos.start + ".";
                      });
                    });
                  });
                </script>
