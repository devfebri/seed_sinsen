            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label class="control-label col-sm-4">Target Dealer Global (Sales In)</label>
                    <div class="col-sm-8">
                      <vue-numeric :disabled='mode == "detail"' class="form-control" v-model='target_dealer.target_global_sales_in' separator='.' currency='Rp'></vue-numeric>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label col-sm-4">Jenis Target Dealer</label>
                    <div class="col-sm-8">
                  ...
                  <div class="form-group">
                    <label class="control-label col-sm-4">Target Dealer Global (Sales Out)</label>

                    <div class="col-sm-8">
                      <vue-numeric :disabled='mode == "detail"' class="form-control" v-model='target_dealer.target_global_sales_out' separator='.' currency='Rp'></vue-numeric>
                    </div>
                  </div>

                </div>
                <?php $this->load->view('modal/h3_md_target_internal_md_modal') ?>
                <?php $this->load->view('modal/h3_dealer_target_sales_dealer') ?>
                <script>
          ...
          data: {
            ...
            <?php else : ?>
              target_dealer: {
                ...
                end_date: '',
                produk: '',
                target_global_sales_in: '',
                target_global_sales_out: '',
                active: 1,
              },
          ...
          methods: {
            <?= $form ?>: function() {
              ...
              post = _.pick(this.target_dealer, [
                'id', 'start_date', 'end_date', 'produk', 'target_global_sales_in', 'target_global_sales_out'
              ]);
    ...
    ?>
      <div class="box">
        ...
        <div class="box-body">
          ...
          <table id="master_target_internal_md" class="table table-bordered table-hover table-condensed">
            <thead>
              <tr>
                <th>No.</th>
                <th>Produk</th>
                <th>Periode awal</th>
                <th>Periode akhir</th>
                <th>Target Dealer Global (Sales In)</th>
                <th>Target Dealer Global (Sales Out)</th>
                <th>Action</th>
              </tr>
            </thead>
            <tbody>
          ...
          <script>
            ...
            $(document).ready(function() {
              master_target_internal_md = $('#master_target_internal_md').DataTable({
                processing: true,
                serverSide: true,
                order: [],
                ajax: {
                  url: "<?= base_url('api/md/h3/master_target_internal_md') ?>",
                  dataSrc: "data",
                  type: "POST",
                  data: function(d) {
