                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <select class="form-control select2" name="type" id="type">
                        ...
                        <option value="laporan_htl_dph_md">HTL DPH MD</option>
                        <option value="laporan_htl_order_ke_ahm">HTL Order ke AHM</option>
                        <option value="laporan_bo_htl_monitoring">BO HTL Monitoring</option>
                        <option value="laporan_htl_sr_monitoring">HTL SR Monitoring</option>
                      </select>
                    </div>
                  </div>
                </div><!-- /.box-body -->
